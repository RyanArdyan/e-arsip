...
<html lang="en">
  ...
  <body class="login-page bg-body-secondary">
        ...
        <div class="card-body login-card-body">
          ...
          <form action="{{ route('registrasi.store') }}" method="post">
            ...
            <div class="input-group mb-3">
              <input name="name" type="text" class="form-control @error('name') is-invalid @enderror" placeholder="Nama" value="{{ old('name') }}" required />
            ...
            <div class="input-group mb-3">
              <select name="kantor_id" class="form-control @error('kantor_id') is-invalid @enderror" required>
                <option value="">-- Pilih Kantor --</option>
                @foreach(\App\Models\Kantor::all() as $kantor)
                  <option value="{{ $kantor->kantor_id }}" {{ old('kantor_id') == $kantor->kantor_id ? 'selected' : '' }}>{{ $kantor->nama_kantor ?? $kantor->name }}</option>
                @endforeach
              </select>
          ...
          <!-- /.social-auth-links -->
          <p class="mb-0 mt-2">
            <a href="{{ route('login') }}" class="text-center"> Sudah registrasi? click disini </a>
          </p>
        </div>
        <!-- /.login-card-body -->
      </div>
    ...
    <script src="{{ asset('AdminLTE-4') }}/dist/js/adminlte.js"></script>
